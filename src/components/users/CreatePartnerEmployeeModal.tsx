...
type CreatePartnerEmployeeModalProps = {
  open: boolean;
...
export default function CreatePartnerEmployeeModal({
  open,
  onOpenChange,
  partnerId,
  onSuccess,
}: CreatePartnerEmployeeModalProps) {
    ...
    >
      <DialogContent className="sm:max-w-[460px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Create a new team member account for your company.
          </DialogDescription>
        </DialogHeader>

        <div className="space-y-3 py-2">
          <div className="space-y-1.5">
            <Label htmlFor="pe-fullName">
